...
export default function Navbar() {
  ...
  const { notifications, unreadCount, showPanel, setShowPanel, markRead, markAllRead } = useNotifications(user?.id);
      ...
      <header className="navbar">
        <div className="container-app navbar-inner">
          ...
          <div className="navbar-right">
            ...
            {user && <NotificationBell count={unreadCount} onClick={() => setShowPanel(!showPanel)} />}
            {user ? (
