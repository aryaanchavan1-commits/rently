...
const g = globalThis as unknown as { __NivasaProperties?: Property[] };
if (!g.__NivasaProperties) g.__NivasaProperties = [];
const properties: Property[] = g.__NivasaProperties;
